...
# Look for .env in parent directory (DjangoDashboardFramework/.env)
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-m(%4_f(l06-oi^ygt7dq=bx3%w_jd--c)z9pd*6x@!umi!t%dt')
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # ปิดชั่วคราวเพื่อทดสอบ
